 ...
 * @created 2018-02-10 04:22:06 PM
 * @version 1.0.0
 * @since 1.0.0
 */
public class DemoDesktopFrame extends javax.swing.JFrame implements ActionListener {
	...
	public void newFrame() {
		JInternalFrame newFrame = new DemoModalityFrame(desktopPane, "Frame " + ++frameCount, true, true, true, true);
	...
	private void initComponents() {
		...
		nonModalDialogMI.setAccelerator(
		...
		tileHorizontalMI.setAccelerator(

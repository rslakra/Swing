...
/**
 * * Wraps <code>JOptionPane</code> so that the modality is controlled. for
 * 
 * 
 * @author Rohtash Lakra (rohtash.lakra@devamatre.com)
 * @author Rohtash Singh Lakra (rohtash.singh@gmail.com)
 * @created 2018-02-10 04:23:27 PM
 * @version 1.0.0
 * @since 1.0.0
 */
public class ModalityInternalOptionFrame extends ModalityInternalFrame {

	public ModalityInternalOptionFrame(final JComponent parentComponent, final JOptionPane optionPane, String title) {
		...
		optionPane.addPropertyChangeListener(new PropertyChangeListener() {
			...
			public void propertyChange(PropertyChangeEvent event) {
				...
				if (frame.isVisible() && event.getSource() == optionPane

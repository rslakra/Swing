 ...
 * @created 2018-02-10 04:23:03 PM
 * @version 1.0.0
 * @since 1.0.0
 */
public class ModalityInternalFrame extends JInternalFrame {
	...
	private void setParentFrame(JComponent parent) {
		...
		this.parent = parent == null ? JOptionPane.getDesktopPaneForComponent(parent) : parent; // default
																								// to
																								// desktop
																								// if
																								// no
	...
	public void calculateBounds() {
		...
		// setBounds((rootSize.width - frameSize.width) / 2, (rootSize.height -
